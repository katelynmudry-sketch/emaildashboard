...
const copy = {
  party: {
    ...
    formPlaceholder: "Tell me your issues! What errors are you seeing? What's broken?",
    sendBtn: "Send",
    sending: "Sending...",
    success: "Sent!",
  ...
  zen: {
    ...
    formPlaceholder: "What errors are you seeing? What feels off? Share anything…",
    sendBtn: "Send",
    sending: "Sending…",
  ...
  "wabi-sabi": {
    ...
    formPlaceholder: "Spill!! What's broken, what's weird, what do you need? 💅",
    sendBtn: "Send",
    sending: "Sending...",
    success: "Sent! 💕",
